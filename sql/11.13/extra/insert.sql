...
--Testcase 18:
CREATE FOREIGN TABLE inserttest01 (col1 int4, col2 int4 NOT NULL, col3 text default 'testing') SERVER duckdb_svr;
--Testcase 1:
...
-- skip, duckdb fdw does not support customized type
/*
