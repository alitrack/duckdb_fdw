...
-- ******************************
--Testcase 1451:
CREATE FOREIGN TABLE v (id int4 OPTIONS (key 'true'), x numeric, val float8) SERVER duckdb_svr;
...
-- DuckDB promises to preserve the first 15 significant decimal digits of the floating point value.
...
--Testcase 1142:
CREATE FOREIGN TABLE NUMERIC_TMP(f1 numeric, f2 numeric, id int OPTIONS (key 'true')) SERVER duckdb_svr;
--Testcase 1143:
