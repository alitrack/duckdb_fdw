...
#### Scenario: Derived endpoint remains data, not SQL
- **WHEN** the S3 Tables endpoint is derived from `s3_region`
- **THEN** the resulting endpoint is emitted as an escaped SQL literal instead of raw string interpolation
