...
CREATE SERVER duck_test FOREIGN DATA WRAPPER duckdb_fdw OPTIONS (database '/tmp/duckdb_fdw_import_schema.db');

SELECT duckdb_execute('duck_test', 'CREATE OR REPLACE TABLE local_data (id INT, price DOUBLE, tags TEXT[])');
